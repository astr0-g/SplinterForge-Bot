...
func PrintConfigSettings(totalAccounts int, headless bool, threadingLimit int, showForgeReward bool, showAccountDetails bool, waitForBossRespawn bool, shareBattleLog bool, closeDriverDuringSleep bool, battlex2 bool, autoSelectCard bool, autoSelectHero bool, autoSelectSleepTime bool, unwantedAbilities []string, randomBosses bool) {
	data := [][]string{
		{"TOTAL_ACCOUNTS_LOADED", fmt.Sprint(totalAccounts)},
		{"HEADLESS", fmt.Sprint(headless)},
		{"THREADING", fmt.Sprint(threadingLimit)},
		{"BATTLEX2",fmt.Sprint(battlex2)},
		{"CLOSE_DRIVER_DURING_SLEEP", fmt.Sprint(closeDriverDuringSleep)},
		...
		{"RANDOM_BOSSES", fmt.Sprint(randomBosses)},
